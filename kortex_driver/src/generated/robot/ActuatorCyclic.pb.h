...
#ifndef PROTOBUF_INCLUDED_ActuatorCyclic_2eproto
#define PROTOBUF_INCLUDED_ActuatorCyclic_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ActuatorCyclic_2eproto 
...
class MessageId : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Kinova.Api.ActuatorCyclic.MessageId) */ {
 public:
  ...
  inline MessageId* New() const final {
    return CreateMaybeMessage<MessageId>(NULL);
  }

  MessageId* New(::google::protobuf::Arena* arena) const final {
...
inline ::Kinova::Api::ActuatorCyclic::MessageId* Command::mutable_command_id() {
  ...
  if (command_id_ == NULL) {
    auto* p = CreateMaybeMessage<::Kinova::Api::ActuatorCyclic::MessageId>(GetArenaNoVirtual());
    command_id_ = p;
  }
...
#endif  // PROTOBUF_INCLUDED_ActuatorCyclic_2eproto
